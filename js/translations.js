...
const translations = {
    tr: {
        ...
        "hero.financials": "Finansal Projeksiyonlar",
        "hero.seed": "Seed Round",
        "hero.loi": "50K ton/yıl",
        "hero.postmoney": "Post-Money",
        "hero.roi": "Hedef ROI",
        ...
        "market.tam.subtitle": "Global Karbon Piyasası",
        "market.sam.title": "$5B",
        ...
        "financials.subtitle": "2026-2032 gelir ve değerleme tahminleri",
        ...
        "funds.breakdown": "Dağılım Detayları",
        ...
        "footer.investor": "Yatırımcı İlişkileri",
    ...
    en: {
        ...
        "hero.financials": "Financial Projections",
        "hero.seed": "Seed Round",
        "hero.loi": "50K ton/year",
        "hero.postmoney": "Post-Money",
        "hero.roi": "Target ROI",
        ...
        "market.tam.title": "$70B+",
        "market.tam.subtitle": "Global Carbon Market",
        "market.sam.title": "$5B",
        ...
        "financials.subtitle": "2026-2032 revenue and valuation estimates",
        ...
        "funds.breakdown": "Breakdown Details",
...
class TranslationManager {
    ...
    applyLanguage(lang) {
        ...
        if (window.updateFinancialTable) {
            window.updateFinancialTable();
        }
        
        if (window.updateROICalculator) {
